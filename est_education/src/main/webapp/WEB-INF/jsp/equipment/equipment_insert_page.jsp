			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">장비등록</h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
		 ...
		 $(document).ready(function() {
			...
			function fn_insertEquipmentCallback(data){
				...
				if(code>0){
					...
					comSubmit.setUrl("<c:url value='/equipment/openEquipmentListPage.do' />");
					comSubmit.submit();
				}else {
			...
			$("#insertButton").on("click", function() {
				...
				comAjax.setUrl("<c:url value='/equipment/insertEquipment.do' />"); //프로그램 URI
