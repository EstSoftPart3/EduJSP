									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="prtnBizRegNum"
												id="inputBizRegNum" placeholder="사업자 등록번호" >
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="date" class="form-control" name="inputRegDt"
												id="inputRegDt" placeholder="ex)대리, 차장" >
										</div>
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="inputCorpRegNum"
												id="inputCorpRegNum" placeholder="ex)123456-0987654" >
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="inputBizAddr"
												id="inputBizAddr" placeholder="ex)구로구 구로동...">
										</div>
									</div>
								</div>
								<!-- /.card-body -->
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="inputBizCnd"
												id="inputBizCnd" placeholder="ex) 서비스 " >
										</div>
										...
										<div class="col-sm-4"> 
											<input type="text" class="form-control" name="inputBizPrd"
												id="inputBizPrd" placeholder="ex) 소프트웨어 개발" >
										</div>
									</div>
									<div class="form-group row">
							...
							<div class="card card-primary">
								...
								<div class="card-body">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="inputDirDrtmtCd"
												id="inputDirDrtmtCd" placeholder="ex) 경영지원 " >
										</div>
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="inputDirPositn"
												id="inputDirPositn" placeholder="ex) 사원, 과장, 대리 ">
										</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control" id="inputDirTelNum2" maxlength="3"  >
										</div>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="inputDirTelNum3" maxlength="4"  >
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-2">
											<input type="text" class="form-control" id="inputDirHpNum2" maxlength="4"  >
										</div>
										<div class="col-sm-2">
											<input type="text" class="form-control" id="inputDirHpNum3" maxlength="4"  >
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="inputDirEmail"
												id="inputDirEmail" placeholder="ex) ASDF@gmail.com" >
										</div>
									</div>
								</div>
								<!-- /.card-body -->
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#selectBizType").on("change", function() {
				...
				console.log(codeComCd + " : 변경전");
				
				codeComCd = $("#selectBizType option:selected").val();
				console.log(codeComCd + " : 변경후");
			...
			$("#insertBtn").on("click", function() {
				...
				comAjax.setUrl("<c:url value='/partner/insertPartner.do'/>"); 
				...
				/* 추가 parameter */
				if(!gfn_isNull(corpRegNum))	{
					
					comAjax.addParam("prtnCorpRegNum", corpRegNum);
				}
				
				comAjax.setCallback(fn_insertPartnerCallback);//콜백 선언
				comAjax.ajax();
			});
		});
	</script>
