			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">스킬 추가</h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4" style="margin-bottom:50px">
											<input type="text" class="form-control textcode" name="mbrTypCd"
												id="inputdylcode" value="01" placeholder="예) 01">
										</div>
										...
										<div id = "inputdylnm_box" class="col-sm-4 textnm" style="margin-bottom:50px">
											<input type="text" class="form-control" name="mbrTypCd"
												id="inputdylnm" placeholder="예) OS">
										</div>
										...
										<div class="col-sm-4" style="margin-bottom:50px">
											<input type="text" class="form-control" name="mbrTypCd"
												id="inputdylcodedtl" placeholder="예) 01">
										</div>
										...
										<div class="col-sm-4" style="margin-bottom:50px">
											<input type="text" class="form-control" name="mbrTypCd"
												id="inputdylnmdtl" placeholder="예) OS">
										</div>
									</div>
								</div>
								<!-- /.card-body -->
	...
	//라디오 버튼 으로 전체 상세 정하기
		...
		$(document).ready(function() {
			...
			$("#insertButton").on("click", function() {
				...
				comAjax.setUrl("<c:url value='/Skill/insertSkill.do' />"); //프로그램 URI
				...
				comAjax.setCallback(fn_insertMemberCallBack);//콜백 선언
				comAjax.ajax();
			});
		})
	</script>
