			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark">질문 등록 화면</h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="bpTtl"
												id="inputbpTtl" placeholder="제목을">
										</div>
									</div>
									
									<div class="form-group row">
										<label for="inputbpCtt" class="col-sm-2 col-form-label">내용</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="bpCtt"
												id="inputbpCtt" placeholder="내용">
										</div>
										
										<label for="inputbpRgl"
											class="col-sm-2 col-form-label text-right">등록자</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" name="bpRgl"
												id="inputbpRgl" placeholder="등록자">
										</div>
									</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#insertButton").on("click", function() {
				...
				comAjax.setUrl("<c:url value='/question/insertQuestion.do' />"); //프로그램 URI
