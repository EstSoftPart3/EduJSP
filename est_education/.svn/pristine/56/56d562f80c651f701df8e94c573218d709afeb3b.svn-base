							...
							<div class="card card-primary">
								...
								<div class="card-body">
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="inputOrder"  name="prjctSortOrder" placeholder="정렬 순번">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="inputRoleDtl" name="prjctRoleDtl"  placeholder="프로젝트목적">
										</div>
									</div>
									<div class="form-group row">
										<label for="inputStartDt" class="col-sm-2 col-form-label">프로젝트 시작일</label>
										<div class="col-sm-4">
											<input type="date" class="form-control" id="inputStartDt" name="prjctStartDt" placeholder="날짜를 선택하세요">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" id="inputCstmrCmpny" name="prjctCstmrCmpny" placeholder="프로젝트마케팅">
										</div>
									</div>
									<div class="form-group row">
									    <label for="inputWrkCmpny" class="col-sm-2 col-form-label">프로젝트 회사</label>
										<div class="col-sm-4">
											<input type="text" class="form-control" id="inputWrkCmpny" name="prjctWrkCmpny" placeholder="프로젝트분산">
										</div>		
									</div>		
								</div>
								<!-- /.card-body -->
 	...
 	function fn_insertProjectCallBack(data) {
		...
		$(document).ready(function() {
			...
			$("#insertButton").on("click", function() {
				...
				var comAjax = new ComAjax();
				comAjax.setUrl("<c:url value='/project/insertProject.do' />"); //프로그램 URI
