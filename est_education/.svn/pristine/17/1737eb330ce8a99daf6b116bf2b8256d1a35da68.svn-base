package com.erp.common.pager;

public class pageMasterBasic {
    // 페이지당 게시물 수
    ...
    public pageMasterBasic(int count, int curPage, int pageScale, int blockScale){
    ...
    public void setBlockRange(){
        ...
        // 페이지 블록의 끝번호
        blockEnd = blockBegin+blockScale;
        // *마지막 블록이 범위를 초과하지 않도록 계산
        if(blockEnd > totPage) blockEnd = totPage+1;
