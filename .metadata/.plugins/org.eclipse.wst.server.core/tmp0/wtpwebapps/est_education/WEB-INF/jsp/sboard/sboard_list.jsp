                          ...
                          <div
                              ...
                              <div class="content-header">
                                  <div class="container-fluid">
                                      <div class="row mb-2">
                                          <div class="col-sm-6">
                                              <h1 class="m-0 text-dark">테스트 게시판</h1>
                                          </div>
                                          <!-- /.col -->
                                          <div class="col-sm-6">
                                              <a href='<c:url value="/sboard/sboardWrite.do" />' class="btn btn-primary float-right">글입력</a>
                                          </div>
                                          <!-- /.col -->
                                      </div>
                                      <!-- /.row -->
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="card-body">
                                              <div style="height: 400px; overflow: auto;">
                                                  <table id="sboard_list" class="table table-hover table-striped table-bordered text-nowrap">
                                                      <thead>
                                                          <tr align="center">
                                                                  <th style="background-color:#efefef">번호</th>
                                                                  <th>제목</th>
                                                                  <th>내용</th>
                                                                  <th>글쓴이</th>
                                                                  <th>작성일</th>
                                                          ...
                                                          <tbody>
                                                              <c:choose>
                                                                  <c:when test="${ fn:length(sboard_list) == 0 }">
                                                                      <tr>
                                                                          <td colspan="6">조회 결과가 없습니다</td>
                                                                      </tr>
                                                                  </c:when>
                                                                  <c:otherwise>
                                                                      <c:forEach var="List" items="${sboard_list}">
                                                                          <tr class="list-row">
...
/*           				$("#updateBtn").on("click", function() {
          				 ...
          				 */ 
          				// 세부정보 페이지로 이동
          				$("#sboard_list").on("click", ".list-row", function(e) {
