					...
					<div class="container-fluid">
						<div class="row mb-2">
							...
							<div class="col-sm-6">
								...
								<a href='<c:url value='/erp/equipment/openEquipmentContentPage.do?update=${ equipmentOne.eqpmntSq }' />' class="btn btn-info float-right" style="margin-right: 10px;">이전으로</a>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<select id="inputStsTcd" class="form-control">
												<option value="정상" <c:if test="${ equipmentOne.eqpmntStsCd eq '정상' }">selected</c:if>>정상</option>
												<option value="고장" <c:if test="${ equipmentOne.eqpmntStsCd eq '고장' }">selected</c:if>>고장</option>
												<option value="수리중" <c:if test="${ equipmentOne.eqpmntStsCd eq '수리중' }">selected</c:if>>수리중</option>
											</select>
										</div>
									</div>
									<div class="form-group row">
										...
										<label for="inputTcd"
											...
											<select id="inputTcd" class="form-control">
												<option value="노트북" <c:if test="${ equipmentOne.eqpmntTypCd eq '노트북' }">selected</c:if>>노트북</option>
												<option value="데스크탑" <c:if test="${ equipmentOne.eqpmntTypCd eq '데스크탑' }">selected</c:if>>데스크탑</option>
												<option value="모니터" <c:if test="${ equipmentOne.eqpmntTypCd eq '모니터' }">selected</c:if>>모니터</option>
												<option value="기타" <c:if test="${ equipmentOne.eqpmntTypCd eq '기타' }">selected</c:if>>기타</option>
											</select>
											</div>
									</div>
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="eqpmntBrand"
												id="inputBrand" placeholder="브랜드명" value="${ equipmentOne.eqpmntBrnd }">
										</div>
										...
										<div class="col-sm-4">
											<input type="Date" class="form-control" name="eqpmntRgstrDate"
												id="inputRgstrDate" value="${ equipmentOne.eqpmntRgstrDate}">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="eqpmntModel"
												id="inputModel" placeholder="모델명" value="${ equipmentOne.eqpmntMdl }">
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-4">
											<input type="text" class="form-control" name="eqpmntSerial"
												id="inputSerial" placeholder="시리얼넘버" value="${ equipmentOne.eqpmntSrl }">
										</div>
										</div>
									<div class="form-group row">
